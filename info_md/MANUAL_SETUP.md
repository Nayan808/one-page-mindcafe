...
| `SHIPROCKET_WEBHOOK_SECRET` | `shiprocket-tracking-webhook` | Make up any random string (e.g. `openssl rand -hex 32`) — you set this same value in both the secret and the Shiprocket webhook URL (step 9) |
