const CONTENT: Record<"privacy" | "terms" | "refund", { title: string; body: string[] }> = {
  privacy: {
    ...
    body: [
      "This page will describe what personal data mindcafé collects, why, and how it's stored and protected.",
  ...
  terms: {
    ...
    body: [
      "This page will set out the terms governing use of mindcafé's products and services.",
      "Placeholder — replace with reviewed copy before this page goes live for real users.",
    ],
  },
  refund: {
