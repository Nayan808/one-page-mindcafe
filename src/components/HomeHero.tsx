  ...
  return (
    <section className="bg-cream">
      <div className="mx-auto flex min-h-[calc(100svh-4.5rem)] max-w-4xl flex-col items-center justify-center px-4 py-16 text-center sm:px-6">
        ...
        <h1 className="font-display mx-auto mt-6 max-w-3xl text-4xl leading-[1.05] font-bold lowercase tracking-tight text-ink sm:text-6xl">
          everyday tools for how you feel — and someone to talk to when you need more.
        </h1>

        <p className="font-tagline mx-auto mt-6 max-w-xl text-lg italic text-ink/70 sm:text-xl">
