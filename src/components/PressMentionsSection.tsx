...
// need for carousel mechanics with a fixed set of 10 logos anyway.
const PRESS = [
      ...
      <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
        {PRESS.map((item, index) => (
          <Reveal key={item.name} delayMs={index * 60}>
            <div className="flex h-20 items-center justify-center rounded-2xl border border-ink/10 bg-white px-4 grayscale transition-all duration-300 hover:grayscale-0 hover:shadow-md">
